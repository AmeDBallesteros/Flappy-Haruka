...
class GameIndicator:
    ...
    def show_score(self, int_score):
        haruka_score = str(int_score)
        score = self.font.render (haruka_score, True, self.color)
        self.screen.blit(score, (WIDTH // 2, 50))
    
    def instructions(self):
        inst_text1 = "Presiona SPACE para saltar,"
        inst_text2 = "Presiona \"R\" para reiniciar el juego"
